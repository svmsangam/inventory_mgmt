...
<div class="panel-heading">
	...
	<div class="pull-right">Invoice No. <strong id="invoiceno">#${invoiceInfo.invoiceNo}</strong></div>
	</div>
</div>
<div class="panel-body">
	<div class="col-sm-4 pull-left">
		<div class="well">
		<h4>To</h4>
		<p><c:if test="${invoiceInfo.customerName != null}"><strong>${invoiceInfo.customerName}</strong></c:if></p>
	...
	<table class="table table-responsive table-striped table-bordered">
		...
		<c:forEach var="oldItem" oldItems="${oldItemList}">
				<tr>
					...
					<td>${oldItem.tax}</td>
					<td>${(oldItem.rate * oldItem.quantity) + (oldItem.rate * oldItem.quantity) * (oldItem.tax/100)} &nbsp; salesItem</td>
				</tr>
			</c:forEach>

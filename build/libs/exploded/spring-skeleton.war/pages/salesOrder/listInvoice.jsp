...
<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Invoice List <a href="${pageContext.request.contextPath}/app/addinvoice"><button class="btn btn-primary btn-sm pull-right">Create New Invoice</button></a>
					</div>
						...
						<tbody>
							<c:forEach var="invoiceInfo" oldItems="${invoiceList}">
								<tr>
									...
									<td><a href="${pageContext.request.contextPath}/app/showinvoice?invoiceId=${invoiceInfo.invoiceId}" >${invoiceInfo.customerName}</a></td>
									...
									<td><%-- <a href="${pageContext.request.contextPath}/app/editinvoice?invoiceId=${invoiceInfo.invoiceId}"
										class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
											Edit </a> --%> <a href="${pageContext.request.contextPath}/app/deleteinvoice?invoiceId=${invoiceInfo.invoiceId}"

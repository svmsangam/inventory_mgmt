...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
			<div class="break"></div>
			<form action="${pageContext.request.contextPath}/editProprietor?id=${storeId}" method="POST" modelAttribute="proprietorDto" class="col-md-12">
				...
				<div class="input-group" id="inputDiv">
					...
					<input type="text" class="form-control" name="temporaryAddress" value="${proprietor.temporaryAddress}" required/>
						...
						<c:forEach var="cityInfo" oldItems="${cityList}">
								<c:choose>
									<c:when
										...
										<option value="${cityInfo.cityName}" selected>${cityInfo.cityName} , ${cityInfo.stateName}</option>
									</c:when>
									<c:otherwise>
										<option value="${cityInfo.cityName}">${cityInfo.cityName} , ${cityInfo.stateName}</option>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							</c:if>
				...
				<div class="input-group" id="inputDiv">
					...
					<input type="text" class="form-control" name="permanentAddress" value="${proprietor.permanentAddress}" required/>
				...
				<div class="col-lg-12"><input type="submit" value="Update Owner Details" class="btn btn-sm btn-success"/></div><br/><br/><br/>
			</form>
			</form>
			</div><!-- /.col-->
		</div><!-- /.row -->

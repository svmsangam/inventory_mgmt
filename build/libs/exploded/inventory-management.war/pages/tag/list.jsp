        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Tag List <a href="${pageContext.request.contextPath}/tagInfo/add"
                                                           style="float:right; margin-bottom:8px;">
                        <button class="btn btn-primary btn-sm">Add New Tag</button>
                    </a>
                    </div>
                    <div class="panel-body">
                        <table id="example" class="table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            <c:forEach var="tagInfo" items="${tagList}" varStatus="counter">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/tagInfo/edit?tagInfo=${tagInfo.tagId}"
                                           class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>
                                            Edit </a> <a
                                            href="${pageContext.request.contextPath}/tagInfo/delete?tagInfo=${tagInfo.tagId}"

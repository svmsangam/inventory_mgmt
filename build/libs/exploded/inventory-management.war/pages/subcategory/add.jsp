	...
	<div class="row">
		<div class="col-lg-6">
			<div class="panel panel-default">
				<div class="panel-heading">Add subCategoryInfo</div>
				<div class="panel-body">
					<form action="${pageContext.request.contextPath}/subCategoryInfo/save"
						...
						<div class="form-group" id="inputDiv">
										...
										<c:forEach var="categoryInfo" items="${categoryList}">
											<c:choose>
												<c:when
													...
													<option value="${categoryInfo.categoryId}" selected>${categoryInfo.categoryName}</option>
												</c:when>
												<c:otherwise>
							...
							</select></td> <label class="lable"> Subcategory name </label> <input
							...
							<label class="lable"> Description</label> <input type="text"
								value="${subCategoryInfo.description }" class="form-control"
						...
						<input type="hidden" name="${_csrf.parameterName}"
							...
							value="Add SubCategory" class="btn btn-primary pull-right">
					</form>
				</div>
			</div>
		</div>

        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-md-offset-5">Edit Sales
                        <div class="pull-right">Order No. #${sales.orderNo}</div>
                    </div>
                </div>
                <div class="panel-body">

                    <form method="post" action="${pageContext.request.contextPath}/app/editsalesorder"
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="">
                                    <label>Customer: ${sales.customerName}</label>
                                </div>
                            ...
                            <div class="col-xs-6 text-right">
                                ...
                                <div class="">
                                    <label>Deliver To: ${sales.deliveryCity}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="inputDiv">
                            ...
                            <table class="table table-responsive table-striped table-bordered"
                                ...
                                <c:if test="${fn:length(sales.oldItemDtoList) gt 0}">
                                    <c:forEach var="oldItem" oldItems="${sales.oldItemDtoList}" varStatus="loop">
                                        <tr>
                                            ...
                                            <td><input type="number" id="input"
                                                       ...
                                                       pattern="[0-9]{5}" class="qty form-control"
                                                       onKeyup="update_amounts();" value="${oldItem.quantity}"
                                                       name="quantity" placeholder="enter quantity" required/></td>
                                            <td><input type="number" step="any"
                                                       onkeypress="return event.charCode > 47 && event.charCode < 58;"
                                                       pattern="[0-9]{5}" class="rate form-control"
                                                       value="${oldItem.rate}" name="rate" required readOnly/></td>
                                            <td><input type="number" step="any"
                                                       onkeypress="return event.charCode > 47 && event.charCode < 58;"
                                                       pattern="[0-9]{5}" class="tax form-control"
                                                       value="${oldItem.tax}" name="tax" required readOnly/></td>
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea name="notes" rows="4" class="form-control">${sales.notes}</textarea>
                        </div>
                        <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $("#add_row").click(function () {
        //alert(count);
        var row = "<tr><td><select id='oldItemList' class='form-control select2 selectMe  mytest myclass" + count + "' arrt='" + count + "' style='width: 100%' name='oldItemList' ><option value='null' selected>select OldItem</option><c:forEach var='oldItem' oldItems='${oldItemList}'><option value='${oldItem.id}'>${oldItem.itemName}</option></c:forEach></select></td>";

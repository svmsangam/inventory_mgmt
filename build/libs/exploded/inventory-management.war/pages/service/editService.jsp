...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="${pageContext.request.contextPath}/app/editservice" method="POST"
                        ...
                        <div class="form-group" id="inputDiv">
                            ...
                            <input type="text" value="${service.serviceName}" id="serviceName" class="form-control"
                        ...
                        <div class="form-group" id="inputDiv">
                            ...
                            <input type="text" value="${service.serviceType}" id="serviceType" class="form-control"
                        ...
                        <div class="form-group" id="inputDiv">
                            ...
                            <input type="number" value="${service.servicePrice}" step="any" id="servicePrice"
   ...
   event.charCode == 46 || event.charCode == 0 " class="form-control double" name="servicePrice" required/>
                        ...
                        <div class="form-group" id="inputDiv">
                            ...
                            <textarea type="text" rows="4" value="${service.description}" id="description"

<%-- 
  - Author(s):Uttam
 - Description: index page for delivery personnel  
  --%>
...
<body>
	...
	<%@include file="../dashboard/deliverypersonnelnavbar.jsp" %>
	<%@include file="../dashboard/deliverypersonnelsidebar.jsp"%>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"> Welcome To Delivery Personnel  Dashboard </h1>
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="panel panel-blue">
					...
					<div class="panel-footer">
						<div class="input-group">
							<input id="btn-input" type="text" class="form-control input-md" placeholder="Add new test" />
							<span class="input-group-btn">

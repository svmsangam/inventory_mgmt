...
<form method="POST" action="${pageContext.request.contextPath}/addBusinessServicePlanForBusinesOwner" modelAttribute="businessService"  class="f1">
				...
				<table class="table table-striped table-bordered">
					...
					<tr>
						<td>Category</td>
						<td><input type="checkbox" name="permission" value="CATEGORY_CREATE" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="CATEGORY_VIEW" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="CATEGORY_UPDATE" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="CATEGORY_DELETE" class="myiterator" disabled="disabled"/></td>
					</tr>

					<tr>
						<td>SubCategory</td>
						<td><input type="checkbox" name="permission" value="SUBCATEGORY_CREATE" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="SUBCATEGORY_VIEW" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="SUBCATEGORY_UPDATE" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="SUBCATEGORY_DELETE" class="myiterator" disabled="disabled" /></td>
					</tr>

					<tr>
						<td>Tag</td>
						<td><input type="checkbox" name="permission" value="TAG_CREATE" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="TAG_VIEW" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="TAG_UPDATE" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="TAG_DELETE" class="myiterator" disabled="disabled"/></td>
					</tr>

					<tr>
						<td>Unit</td>
						<td><input type="checkbox" name="permission" value="UNIT_CREATE" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="UNIT_VIEW" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="UNIT_UPDATE" class="myiterator" disabled="disabled"/></td>
						<td><input type="checkbox" name="permission" value="UNIT_DELETE" class="myiterator" disabled="disabled"/></td>
					</tr>

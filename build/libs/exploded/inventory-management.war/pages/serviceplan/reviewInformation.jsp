...
<%@include file="../common/sidebar.jsp"%>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<input type="hidden" id="storeId" value="${storeInfo.storeId}"/>
			...
			<a href="${pageContext.request.contextPath}/business"><button class="btn btn-primary pull-right">Back To List</button></a>
			<a href="${pageContext.request.contextPath}/editbusiness?storeId=${storeInfo.storeId}" class="btn btn-success">Edit Business Details</a>
			<a href="${pageContext.request.contextPath}/deletebusiness?storeId=${storeInfo.storeId}" class="btn btn-danger" onclick="return confirm('Are you sure, you want to DELETE?')">Delete</a>
			<br/><br/>

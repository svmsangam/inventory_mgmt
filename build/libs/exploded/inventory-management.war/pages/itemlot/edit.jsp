...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Item Lot edit</li>
        </ol>
    </div>
    <!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">Edit ItemLot</div>
                <div class="panel-body">
                    <form action="${pageContext.request.contextPath}/itemInfo/update"
                          method="POST" modelAttribute="itemInfo"
                          enctype="multipart/form-data" id="registerform"
                          novalidate="novalidate" class="col-lg-8">
                        <input type="hidden" name="categoryId" value="${itemInfo.itemLotId}"/>
                        ...
                        <div class="form-group" id="inputDiv">
                            ...
                            <label class="lable"> Total Quantity</label> <input type="text"
                                                                                value="${itemInfo.totalQuantity }"
                                                                                class="form-control"

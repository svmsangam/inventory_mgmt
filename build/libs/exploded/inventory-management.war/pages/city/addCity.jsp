...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Add City</h2>
        </div>
    </div><!--/.row-->

    <div class="col-sm-6">
        <form method="post" action="${pageContext.request.contextPath}/addcity" modelAttribute="cityDto">
            <table>
                <tr>
                    <td><label class="lable">City Name: </label></td>
                    <td>
                        <input class="form-control" placeholder="City Name" type="text" name="cityName"
                               value="${cityInfo.cityName}" required/>
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <td><br/><input type="submit" value="Add City" class="btn btn-sm btn-success"/></td>
                </tr>
            </table>
        </form>
    </div>

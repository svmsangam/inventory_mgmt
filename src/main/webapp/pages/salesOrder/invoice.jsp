                    ...
                    <form action="${pageContext.request.contextPath}/app/addinvoice"
                            ...
                            <select class="form-control select2 clientInfo" name="customerId" disabled="disabled">
                                ...
                                <c:forEach var="clientInfo" oldItems="${customerList}">
                                    <option value="${clientInfo.customerId}"
                                            class="cs">${clientInfo.uniqueName}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3" id="inputDiv">
                            ...
                            <input type="text" id="invoiceDate" name="invoiceDate" value="${invoiceInfo.invoiceDate }"
                                   class="form-control datepicker" placeholder="invoiceInfo date" required/>
                            <p class="error">${error.invoiceDate}</p>
                        </div>

                        <div class="col-md-3" id="inputDiv">
                            <label class="lable">Due Date </label>
                            <input type="text" class="form-control" id="datepicker2" name="dueDate"
                                   value="${invoiceInfo.dueDate }" placeholder="due date" required/>
                            <p class="error">${error.dueDate}</p>
                        </div>

                        <div id="inputDiv">
                            <a id="" myid="add_row" class="btn btn-xs btn-primary pull-left idclass"><span
                            ...
                            <table class="table table-responsive table-striped table-bordered"
                                ...
                                <tbody>
                                <tr class="auto">
                                    <td style="display: none;"><input type="hidden" name="oldItemIdList"
                        ...
                        <div class="row">
                            <div class="col-md-4" id="inputDiv">
                                ...
                                <textarea rows="4" id="input" placeholder="write something.." class="form-control"
                                          name="notes" value="${invoiceInfo.notes}"></textarea>
                            </div>

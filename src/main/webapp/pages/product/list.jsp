			...
			<div class="col-xs-12">
				<div class="box box-info">
					<div class="box-header">
						...
						<div class="box-tools">
							<button class="btn btn-success btn-sm btn-flat pull-right filter"
										...
										<ul class="pagination">
											...
											<c:if test="${currentpage > 1}">
												<li class="page-item"><a
													href="${pageContext.request.contextPath}/product/list?pageNo=${currentpage-1}"
												...
												<c:choose>
													<c:when test="${pagelist == currentpage}">
														...
														<li class="page-item active"><span class="page-link">
																${pagelist} <span class="sr-only">(current)</span>
														</span></li>

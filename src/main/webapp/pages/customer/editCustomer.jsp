        ...
        <div class="col-lg-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="${pageContext.request.contextPath}/app/editcustomer" method="POST"
                          modelAttribute="customerDto"
                          enctype="multipart/form-data" class="col-lg-6" id="registerform" novalidate="novalidate">

                        <input type="hidden" name="customerId" value="${clientInfo.customerId}">

                        <div class="form-group" id="inputDiv">
                            <label class="lable" for="firstName">First Name * </label>
                        ...
                        <div class="form-group" id="inputDiv">
                            <label class="lable" for="middleName">Middle Name </label>
                        ...
                        <div class="form-group" id="inputDiv">
                            <label class="lable" for="lastName">Last Name * </label>
                        ...
                        <div class="form-group" id="inputDiv">
                            <label class="lable" for="uniqueName">Unique Name * </label>
                        ...
                        <div class="form-group" id="inputDiv">
                            <label class="lable" for="mobileNo">MobileNo * </label>
                        ...
                        <div class="form-group" id="inputDiv">
                            <label class="lable" for="landline">Landline * </label>

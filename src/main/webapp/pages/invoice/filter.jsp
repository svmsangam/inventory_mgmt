                             ...
                             <div class="row">
                                 <div class="dropdown pull-right">
                                     ...
                                     <ul class="dropdown-menu">
                                         <li><a href="${pageContext.request.contextPath}/report/invoice/filter/pdf?pageNo=${currentpage}&from=<fmt:formatDate pattern="MM/dd/yyyy" value="${filterDTO.from}"/>&to=<fmt:formatDate pattern="MM/dd/yyyy" value="${filterDTO.to}"/>&fiscalYearId=${filterDTO.fiscalYearId}&clientId=${filterDTO.clientId}&amountGt=<fmt:formatNumber type="number" maxFractionDigits="3" groupingUsed="false" value="${filterDTO.amountGt}"/>&amountLt=<fmt:formatNumber type="number" maxFractionDigits="3" groupingUsed="false" value="${filterDTO.amountLt}"/>&receivableGt=<fmt:formatNumber type="number" maxFractionDigits="3" groupingUsed="false" value="${filterDTO.receivableGt}"/>&receivableLt=<fmt:formatNumber type="number" maxFractionDigits="3" groupingUsed="false" value="${filterDTO.receivableLt}"/>" target="_blank"><i class="fa fa-file-pdf-o"></i> PDF</a></li>
                                         <li class="divider"></li>
                                         <li><a href="${pageContext.request.contextPath}/report/invoice/filter/xls?pageNo=${currentpage}&from=<fmt:formatDate pattern="MM/dd/yyyy" value="${filterDTO.from}"/>&to=<fmt:formatDate pattern="MM/dd/yyyy" value="${filterDTO.to}"/>&fiscalYearId=${filterDTO.fiscalYearId}&clientId=${filterDTO.clientId}&amountGt=<fmt:formatNumber type="number" maxFractionDigits="3" groupingUsed="false" value="${filterDTO.amountGt}"/>&amountLt=<fmt:formatNumber type="number" maxFractionDigits="3" groupingUsed="false" value="${filterDTO.amountLt}"/>&receivableGt=<fmt:formatNumber type="number" maxFractionDigits="3" groupingUsed="false" value="${filterDTO.receivableGt}"/>&receivableLt=<fmt:formatNumber type="number" maxFractionDigits="3" groupingUsed="false" value="${filterDTO.receivableLt}"/>" target="_blank"><i class="fa fa-file-excel-o"></i> XLS</a></li>
                                     </ul>
                                 </div>
                             </div>
                         </div>

        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="${pageContext.request.contextPath}/app/addpurchaseorder"
                            ...
                            <table class="table table-responsive table-striped table-bordered"
                                ...
                                <c:if test="${fn:length(purchaseOrder.oldItemDtoList) gt 0}">
                                    <c:forEach var="checkItem" oldItems="${purchaseOrder.oldItemDtoList}"
                                        ...
                                        <tr>
                                            <td>
                                                <select id="oldItemList" class="form-control mytest"
                                                        arrt="${loop.index}" style="width: 100%" name="oldItemList"
                                                        required>
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea name="notes" id="notes" class="form-control"
                                      rows="4">${purchaseOrder.notes}</textarea>
                        </div>
                        <br/>
                        <br/>

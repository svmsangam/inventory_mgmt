        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/app/addbillpurchaseorder"
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                ...
                                <select name="purchaseOrderDto.orderId" onChange="getPurchaseOrderValue();"
                                        id="load-values" class="form-control selectMe" required>
                            ...
                            <div class="col-lg-3">
                                ...
                                <input class="form-control" placeholder="Vendor name" type="text" id="vendor"
                                       name="vendorDto.contactName" value="${billPurchaseOrder.vendorDto.contactName}"
                                       required/>
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="text" placeholder="select date" id="billDate"
                                       class="datepicker form-control" name="billDate"
                            ...
                            <div class="col-lg-3">
                                ...
                                <input type="text" placeholder="select date" id="dueDate"
                                       class="datepicker form-control" name="dueDate"
                                ...
                                <c:if test="${fn:length(billPurchaseOrder.purchaseOrderDto.oldItemDtoList) gt 0}">
                                    <c:forEach oldItems="${billPurchaseOrder.purchaseOrderDto.oldItemDtoList}"
                                        ...
                                        <tr>
                                            ...
                                            <td>${purchaseOrderItems.quantity}<input type="hidden"
                                                                                     class="form-control qty"
                                                                                     value="${purchaseOrderItems.quantity}"/>
                                            </td>
                                            <td>${purchaseOrderItems.rate}<input type="hidden" class="form-control rate"
                                                                                 value="${purchaseOrderItems.rate}"/>
                                            </td>
                                            <td>${purchaseOrderItems.tax}<input type="hidden" class="form-control tax"
                        ...
                        <div class="form-group pull-right">
                            <label class="lable">Total Cost </label> <input type="text"
                                                                            ...
                                                                            id="totalCost" class="form-control input-md"

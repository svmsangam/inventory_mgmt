                    ...
                    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 form-box">
                    	<form role="form" action="" method="post" class="f1">
                    		...
                    		<div class="f1-steps">
                    		    ...
                    		    <div class="f1-step">
                    				<div class="f1-step-icon"><svg class="glyph stroked app window with content"><use xlink:href="#stroked-app-window-with-content"/></svg></div>
                    				<p>Amount</p>
                    			</div>
                    		</div>
                            ...
                            <fieldset>
                               ...
                               <div class="form-group">
                    			    ...
                    			    <select name="receivingAccountType" id="f1-sending-account-type" class="select2 form-control">
                    			    	<option value="default">Account Type</option>
                    			    	<option value="CURRENT">Current</option>
                    			    	<option value="SAVING">Saving</option>
                    			    </select>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sendingAmount" placeholder="Sending Amount" class="form-control" id="sendingAmount">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="f1-twitter">Receiving Amount</label>
                                    <input type="text" name="receivingAmount" placeholder="Receiving Amount" class="form-control" id="receivingAmount">
                                </div>
                               <!--  <div class="form-group">

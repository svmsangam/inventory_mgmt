        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="col-md-offset-5">Add Sales Order
                        <div class="pull-right">Order No. #${orderNo}</div>
                    </div>
                </div>
                <div class="panel-body">

                    <form method="post" action="${pageContext.request.contextPath}/order/savesale"
                          modelAttribute="orderInfo" id="registerform" novalidate="novalidate">
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <input type="text" placeholder="clientInfo name" class="searchCustomer form-control"
                                           id="customerName" required/>
                                    <a class="addCustomer btn btn-info btn-sm" style="margin-top: 8px;"
                            ...
                            <div class="col-xs-6 text-right">
                                <div class="form-group">
                                    <label name="shipmentChannel">Shipment Channel:
                                        <select class="form-control select2" name="shipmentChannel" id="shipmentChannel"
...
<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDKERYllGf5BfVR_c_45nqHVkbHoPgXPDA&sensor=false&amp;libraries=places"

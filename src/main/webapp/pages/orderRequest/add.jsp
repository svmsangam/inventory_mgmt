        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/order/save"
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <div class="form-group col-xs-12">
                                    <label name="vendorDto">Order Type:
                                        <select class="form-control select2" name="orderType" id="orderType"
                            ...
                            <div class="col-xs-6 text-right">
                                ...
                                <div class="form-group">
                                    <label>Deliver To:
                                        <input class="form-control" type="text" id="deliveryCity" name="deliveredTo"
